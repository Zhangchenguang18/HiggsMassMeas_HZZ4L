...
//	doPlots(-2.4,2.4,0,0,0,0);
//	doPlots(-2.4,2.4,0,0,0,1);
//		 doPlots(0,0.9,1,0,1,0);
//		 doPlots(0.9,1.8,1,0,1,0);
//		 doPlots(1.8,2.4,1,0,1,0);
		 doPlots(0,0.8,0,1,1,0);
		 doPlots(0.8,1,0,1,1,0);
		 doPlots(1,2.5,0,1,1,0);
...
//	t->SetBranchAddress("id2",&id2);
	...
	for(Int_t i=0; i<sum; i++){
		...
		if(RelIso1>0.1||RelIso2>0.1)continue;
...
//			counter=counter+1;
	...
	c->SaveAs("/home/chenguan/public_html/2Dmaps/"+year+"/"+filename+"_"+name+".pdf");
	h->Print();
	//cout<<sum<<endl;
//	cout<<counter<<endl;	
//	cout<<p1<<"****"<<p2<<endl;
