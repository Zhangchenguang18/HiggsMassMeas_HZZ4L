	  ...
	  const ElectronEnergyCalibrator::EventType eventType) const
{
  ...
  //std::cout<<"gain: "<<gainSeedSC<<std::endl;
  ...
  uncertainties[EGEnergySysIndex::gainseed] = gainSeedSC;
  uncertainties[EGEnergySysIndex::r9] = ele.full5x5_r9();
  uncertainties[EGEnergySysIndex::scabseta] = scEtaAbs;
			  ...
			  std::array<float,EGEnergySysIndex::kNrSysErrs>& energyData)const
{
  ...
  //std::cout<<"ElectronEnergyCalibrator "<<scaleCorr.scaleErrStat()<<"  "<<scaleCorr.scaleErrSyst()<<"  "<<scaleCorr.scaleErrGain()<<"  "<<scaleCorr.scaleErr(EnergyScaleCorrection::kErrStatSystGain)<<std::endl;
  ...
  energyData[EGEnergySysIndex::ScaleUpECALOnly] = ele.ecalEnergy()*corrScaleUp;
  energyData[EGEnergySysIndex::ScaleDnECALOnly] = ele.ecalEnergy()*corrScaleDn;
