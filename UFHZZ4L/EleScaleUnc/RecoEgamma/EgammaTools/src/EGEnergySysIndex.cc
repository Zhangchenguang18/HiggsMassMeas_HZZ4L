...
namespace{
  std::array<std::string,EGEnergySysIndex::kNrSysErrs> makeEGEnergySysNames(){
    ...
    names[EGEnergySysIndex::gainseed] = "gainseed";
    names[EGEnergySysIndex::r9] = "r9";
    names[EGEnergySysIndex::scabseta] = "scabseta";
    names[EGEnergySysIndex::ScaleUpECALOnly] = "scaleupecalonly";
    names[EGEnergySysIndex::ScaleDnECALOnly] = "scalednecalonly";
    return names;
  }
}
