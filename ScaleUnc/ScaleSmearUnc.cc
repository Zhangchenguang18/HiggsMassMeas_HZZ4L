...
//cout<<"22222"<<endl;
	...
	c->SaveAs("/home/chenguan/public_html/Syst_uncertainty/LepEnergyScale/"+year+"/ScaleShift/scaleunc_"+fs+"_Normal.png");
...
//	RooFormulaVar meanDCB_up("meanDCB","@1+@0",RooArgList(meanDCB2,shift_up)); 
	...
	c->SaveAs("/home/chenguan/public_html/Syst_uncertainty/LepEnergyScale/"+year+"/ScaleShift/scaleunc_"+fs+"_Up.png");
...
//	RooFormulaVar meanDCB_dn("meanDCB","@1+@0",RooArgList(meanDCB3,shift_dn));
	...
	c->SaveAs("/home/chenguan/public_html/Syst_uncertainty/LepEnergyScale/"+year+"/ScaleShift/scaleunc_"+fs+"_Down.png");
