...
//  double lep1_precorr,lep1_postcorr,lep2_precorr,lep2_postcorr;
...
//  if(!tree) { cout<<"ERROR could not find the tree for "<<filename<<endl; return -1;}
  TChain* ch = new TChain("Ana/passedEvents");
...
//  newtree->Branch("lep1_postcorr", &lep1_postcorr, "lep1_postcorr/D");
//  newtree->Branch("lep1_precorr", &lep1_precorr, "lep1_precorr/D");
//  newtree->Branch("lep2_postcorr", &lep2_postcorr, "lep2_postcorr/D");
//  newtree->Branch("lep2_precorr", &lep2_precorr, "lep2_precorr/D");
...
*/
            phi1 = double((*lep_phi)[L1]); m1 = double((*lep_mass)[L1]);//old variable is *lep_phi, change it to lep_mass
...
//	    lep1_postcorr = (*lep_ecalTrkEnergyPostCorr)[L1];
//	    lep2_postcorr = (*lep_ecalTrkEnergyPostCorr)[L2];
//	    lep1_precorr = (*lep_ecalTrkEnergyPreCorr)[L1];
//	    lep2_precorr = (*lep_ecalTrkEnergyPreCorr)[L2];
...
//            cout<<"genidex  "<<*lep_genindex[L1]<<"   "<<*lep_genindex[L2]<<endl;
